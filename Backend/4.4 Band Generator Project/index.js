...
function randomNameGen(req, res, next){
  var ranNum1 = Math.floor(Math.random() * adj.length);
  var ranNum2 = Math.floor(Math.random() * adj.length);
  console.log(ranNum1);
  console.log(ranNum2);
  name = adj[ranNum1] + " " + adj[ranNum2];
  console.log(name);
  next();
}

// app.use(randomNameGen);
...
app.post("/submit", randomNameGen, (req, res) => {
